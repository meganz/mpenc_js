...
(function() {
   ...
   _bi255.prototype = {
    ...
    var _recover_exponent = _q.plus(_bi255(3)).divide(_bi255(8));
    var _d = _q.minus(_bi255(121665)).divide(_bi255(121666));
    var _i = _two.pow(_q.minus(_one).divide(_bi255(4)));
    var _l = _two.pow(_bi255(252)).plus(_bi255('14def9dea2f79cd65812631a5cf5d3ed'));

    /**
     * FIXME: This function is not constant time!
     *
     * It is copied from curve255.js c255lreduce(), but it failed if the
     * conditional ``if (v < 0x8000)`` was omitted in this implementation.
     */
    function _myReduce(a) {
        var v = a[15];
        if (v < 0x8000) {
            return;
        }
    ...
    function _xrecover(y) {
        ...
        var x = xx.pow(_recover_exponent);
