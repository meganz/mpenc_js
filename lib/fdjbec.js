...
// use cmp from the old curve25519.js
// fast-djbec is not compatible with the new one from curve255.js
...
fdjbec.bytes2string = bytes2string;
fdjbec.string2bytes = string2bytes;
fdjbec.publickey = publickey;
fdjbec.signature = signature;
fdjbec.checksig = checksig;
})();
